...
A free bilingual (KO/EN) PWA for nursing study — 657 randomized board-style questions (99 SVG image-based) plus a survival "shift" mode with bosses, combos, and image-based clinical scenarios. **v3.4 — soft neumorphic / sage-green design.**
...
- **657 randomized clinical questions** (558 text + **99 image-based** SVG questions covering ECG strips (V-fib/asystole/pacer), anatomy diagrams, JVD/skin turgor, scales, positioning, respiratory patterns, urine colors, Bristol stool, fontanelles, and procedure visuals) across 8 nursing-board subjects, including **NCLEX-style** delegation, HIPAA, and drug calculation questions

...
한국 간호사 국가고시 + NCLEX-RN 학습을 위한 임상 시뮬레이션 + 문제풀이 하이브리드 앱.
**Android · PWA · Electron 데스크톱** 어느 환경에서도 동작합니다.

> ⚠️ **학습 보조 도구입니다.** 실제 임상 의사결정은 면허 의료인과 공식 가이드라인(KNCA, AHA, USPSTF 등)을 따르세요.

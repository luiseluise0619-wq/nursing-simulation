...
A free bilingual (KO/EN) PWA for nursing study — 873 randomized board-style questions (145 SVG image-based) plus a survival "shift" mode with bosses, combos, and image-based clinical scenarios. **v4.1 — soft neumorphic / sage-green design.**

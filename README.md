...
A free bilingual (KO/EN) PWA for nursing study — 623 randomized board-style questions (92 SVG image-based) plus a survival "shift" mode with bosses, combos, and image-based clinical scenarios. **v3.3 — soft neumorphic / sage-green design.**
...
- **623 randomized clinical questions** (531 text + **92 image-based** SVG questions covering ECG strips, anatomy diagrams, charts, scales, positioning, respiratory patterns, urine colors, and procedure visuals) across 8 nursing-board subjects, including **NCLEX-style** delegation, HIPAA, and drug calculation questions

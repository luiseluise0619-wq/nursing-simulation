...
A free bilingual (KO/EN) PWA for nursing study — 903 randomized board-style questions (152 SVG image-based) plus a survival "shift" mode with bosses, combos, and image-based clinical scenarios. **v4.2 — soft neumorphic / sage-green design.**

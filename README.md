...
A free bilingual (KO/EN) PWA for nursing study — 689 randomized board-style questions (105 SVG image-based) plus a survival "shift" mode with bosses, combos, and image-based clinical scenarios. **v3.5 — soft neumorphic / sage-green design.**
...
- **689 randomized clinical questions** (584 text + **105 image-based** SVG questions covering ECG strips (V-fib/asystole/pacer), anatomy diagrams, JVD/skin turgor, scales, positioning, respiratory patterns, urine sediment, RBC morphology, IV complications, and procedure visuals) across 8 nursing-board subjects, including **NCLEX-style** delegation, HIPAA, and drug calculation questions

...
```
한국 간호사 국가고시 + NCLEX-RN 무료. 69편 임상 시뮬레이션. 듀티처럼 공부.
```
...
• 69편 임상 시뮬레이션 (정신/소아/응급/산과/내과/외과/노인/호스피스)
...
69편 임상 시뮬레이션 + 2,480 정적 문제 + 약물 드릴.
...
### 출시 X = 가치 0
콘텐츠 2,480문제도, 69편 시뮬레이션도, S 등급 코드도 — **사용자 없으면 모두 0**.
